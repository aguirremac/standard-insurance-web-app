...
export default function AboutUsPage() {
  return (
    <main className="bg-gray-50 text-gray-900">
      ...
      {/* Call-to-Action */}
      <section className="bg-[#042E4C] text-white py-16 text-center px-6">
        ...
        <a
          href="#quote"
          className="inline-block bg-white text-[#042E4C] font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-gray-100 transition"
        >
          Get a Free Quote
        </a>
      </section>
