...
export default function AboutUsPage() {
  ...
  const texts: Record< "EN" | "KO", Record<string, string>> = {
    EN: {
      ...
      historyContent: "Standard Insurance Services was established in 2025 by an insurance broker with 17 years of insurance experiences across insurance types and borders.",
    ...
    KO: {
      aboutTitle: "회사 소개",
      historyTitle: "회사 연혁",
      historyContent: "스탠다드 보험은 17년간 호주, 한국 및 중동에서 또 보험사와 보험중개회사에서 리테일 및 다양한 기업 보험 경력을 가진 대표 보험브로커에 의해 설립되었습니다.",
      representativeTitle: "대표 보험 브로커",
      representativeContent1: "스탠다드 보험은 회사 라이선스가 있는 보험 브로커로서, 보험사 대신 고객을 대변합니다. 이는 독립적인 조언과 고객의 다양한 요구에 맞는 최상의 보장을 받을 수 있음을 의미합니다.",
      representativeContent2: "고객의 비즈니스와 자산 보호에 가장 적합한 보험을 안내 드립니다.",
