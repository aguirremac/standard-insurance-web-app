...
const pillarsEN = [
  ...
  },
  {
    icon: Users,
    title: "Client First",
    desc: "Tailored insurance solutions.",
...
const pillarsKO = [
  {
    icon: Shield,
    title: "신뢰를 바탕으로",
    desc: "고객의 소중한 자산을 보호하기 위해 정직하고 믿을 수있는 보험 서비스를 제공합니다..",
    image: "/pillars/trust.jpg",
  },
  {
    icon: Clock,
    title: "신속한 보험서비스가 필요하실 때 연락주십시오",
...
const texts: Record<"EN" | "KO", Record<string, string>> = {
  EN: {
    ...
    storyDescription1:
      "Standard Insurance was founded with a simple belief: insurance should be clear, practical and client focused.",
    // storyDescription2:
    ...
    storyDescription4:
      "Standard Insurance works with a broad network of trusted insurers across Australia, delivering tailored cover for individuals, businesses, and complex risks. While the industry continues to evolve, our approach remains the same.",
  },
  KO: {
    header: "간편한 보험.",
    subHeader: "믿을 수 있는 보험 커버.",
    // description:
    //   "Standard Insurance 는 실제 사람과 실제 위험을 중심으로 명확하고 신뢰할 수 있는 보장을 제공합니다. 복잡성 없음. 숨겨진 조건 없음.",
    storyHeader: "경험에 기반하여 확실하게 서비스하겠습니다.",
    storyDescription1:
      "Standard Insurance 는 보험이 명확하고 실용적이며 고객 중심이어야 한다는 단순한 믿음으로 설립되었습니다.",
    // storyDescription2:  
    ...
    storyDescription4:
      "Standard Insurance는 호주 전역의 신뢰할 수 있는 보험사 네트워크와 협력하여 개인, 기업 및 복잡한 위험에 맞춤형 보장을 제공합니다.보험 산업이 계속 진화함에도 불구하고, 저희의 접근 방식은 동일합니다.",
  },
};
