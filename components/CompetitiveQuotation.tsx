...
const texts: Record< "EN" | "KO", Record<string, string>> = {
  ...
  KO: {
    ...
    content1: "보험료는 고객이 받는 실제 보험 커버 수준을 반영해야 합니다. 저희의 경쟁력 있는 견적 서비스는 제한된 보장에 대해 과도한 비용을 지불하거나 고객의 위험 프로필과 일치하지 않는 혜택에 대해 비용을 지불하지 않도록 보장합니다.",
    content2: "저희는 광범위한 보험사 네트워크와 협력하여 여러 견적을 얻고,  보험 조건을 신중하게 비교합니다. 이를 통해 단순한 가격이 아닌 가치에 기반하여 가장 적합한 옵션을 추천할 수 있습니다.",
    content3: "비즈니스나 고객 자산에 대한 보험서비스에 있어, 저희의 접근 방식은 투명성과 비용 효율성을 보장합니다. 저희는 고객의 필요에 맞는 맞춤형 커버를 경쟁적인 보험료로 견적합니다.",
    ctaTitle: "경쟁력 있는 보험 제안 받기",
    ctaContent: "포괄적인 커버와 비용 효율성을 균형 있게 제공하는 견적을 제공하겠습니다.",
    requestQuotation: "견적",
  },
};
